...
//         try {
//             const response = await api.get('/integration/aqi');
//             const data = response.data.aqi_data;
//             setOverallValue(parseInt(data.aqi, 10));
//         } catch (error) {
...
//                                 <stop offset="25%" style={{ stopColor: 'rgb(165, 244, 8)', stopOpacity: 1 }} />
//                                 <stop offset="50%" style={{ stopColor: 'orange', stopOpacity: 1 }} />
//                                 <stop offset="75%" style={{ stopColor: 'red', stopOpacity: 1 }} />
//                                 <stop offset="90%" style={{ stopColor: 'rgb(97, 4, 97)', stopOpacity: 1 }} />
//                                 <stop offset="100%" style={{ stopColor: 'rgb(60, 5, 60)', stopOpacity: 1 }} />
//                             </linearGradient>
//                         </defs>
    ...
    <CardWrapper border={false} content={false}>
      ...
      >
        ...
        >
          ...
          >
            <GaugeReferenceArc thickness={15} color="rgba(0, 0, 0, 0.1)" />
            <GaugeValueArc thickness={15} sx={{ fill: getColor(overallValue) }} />
            <GaugeTicks />
            <GaugePointer color={pointerColor} />
          </GaugeContainer>
          <Box
